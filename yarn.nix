{fetchurl, linkFarm}: rec {
  ...
  packages = [
    ...
    {
      name = "node-rest-client-2.5.0.tgz";
      path = fetchurl {
        name = "node-rest-client-2.5.0.tgz";
    ...
    {
      name = "nodemailer-direct-transport-3.3.2.tgz";
      path = fetchurl {
        name = "nodemailer-direct-transport-3.3.2.tgz";
    ...
    {
      name = "nodemailer-fetch-1.6.0.tgz";
      path = fetchurl {
        name = "nodemailer-fetch-1.6.0.tgz";
    ...
    {
      name = "nodemailer-shared-1.1.0.tgz";
      path = fetchurl {
        name = "nodemailer-shared-1.1.0.tgz";
    ...
    {
      name = "nodemailer-smtp-pool-2.8.2.tgz";
      path = fetchurl {
        name = "nodemailer-smtp-pool-2.8.2.tgz";
    ...
    {
      name = "nodemailer-smtp-transport-2.7.2.tgz";
      path = fetchurl {
        name = "nodemailer-smtp-transport-2.7.2.tgz";
    ...
    {
      name = "smtp-connection-2.12.0.tgz";
      path = fetchurl {
        name = "smtp-connection-2.12.0.tgz";
